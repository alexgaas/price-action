...
class DataJobFifteenMinImpl(
    ...
    override fun execute(context: JobExecutionContext?) {
        if (!scheduleConfigurationProperties.scheduleToggle.fifteenMinEnabled) {
            log.debug("Scheduler to get market data for fifteen minutes is disabled")
            return
        }
