...
class DataJobFiveMinImpl(
    ...
    override fun execute(context: JobExecutionContext?) {
        if (!scheduleConfigurationProperties.scheduleToggle.fiveMinEnabled) {
            log.debug("Scheduler to get market data for five minutes is disabled")
            return
        }
