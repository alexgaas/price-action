...
class DataJobOneHourImpl(
    ...
    override fun execute(context: JobExecutionContext?) {
        if (!scheduleConfigurationProperties.scheduleToggle.oneHourEnabled) {
            log.debug("Scheduler to get market data for one hour is disabled")
            return
        }
