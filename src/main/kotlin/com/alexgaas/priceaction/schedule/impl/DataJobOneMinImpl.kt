...
class DataJobOneMinImpl(
    ...
    override fun execute(context: JobExecutionContext?) {
        if (!scheduleConfigurationProperties.scheduleToggle.oneMinEnabled) {
            log.debug("Scheduler to get market data for one minute is disabled")
            return
        }
